    ...
    <div data-custom-class="body">
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          ...
          >
            ...
            ', or '<strong>our</strong>'<bdt className="else-block" />)
            <span
              style={{
                fontSize: "11.0pt",
                lineHeight: "115%",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <span
                      style={{
                        fontSize: "11.0pt",
                        lineHeight: "115%",
                        msoFareastFontFamily: "color:#595959",
                        msoThemecolor: "text1",
                        msoThemetint: 166
                      }}
                    >
                  ...
                  at <bdt className="question">motavarachha</bdt>
                  <bdt className="block-component" />
                </span>
              </span>
              , <bdt className="question">Gujerat</bdt>
            </span>
          </span>
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          ...
          >
            ...
            <span style={{ color: "rgb(0, 58, 250)" }}>
              <bdt className="question">https://dvysun-ecomm-k7ek9wqfz-kartiks-projects-6330a69c.vercel.app/</bdt>
            </span>{" "}
        ...
        >
          ...
          >
            ...
            phone at <bdt className="question">+91 98751 03176</bdt>, email at{" "}
            <bdt className="question">cdmikartiktimbadiya@gmail.com</bdt>
            <bdt className="block-component" />,
            <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
            <bdt className="question">motavarachha</bdt>
            <bdt className="block-component" />,{" "}
            <bdt className="question">Gujerat</bdt>
            <bdt className="block-component" />
            <bdt className="block-component" />
        ...
        >
          ...
          >
            ...
            ), and <bdt className="question">DVYSUN</bdt>, concerning your access to
        ...
        >
          ...
          >
            ...
            or modifications to these Legal Terms{" "}
            <bdt className="block-component" />
            at any time and for any reason
            <bdt className="statement-end-if-in-editor" />. We will alert you about
            any changes by updating the <bdt className="block-component" />
            'Last updated'
            <bdt className="else-block" /> date of these Legal Terms, and you waive
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
          ...
          <a data-custom-class="link" href="#copyrightno">
            <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
              <span data-custom-class="body_text">14. COPYRIGHT INFRINGEMENTS</span>
            </span>
          </a>
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="body_text">
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          ...
          >
            ...
            in the Services (collectively, the <bdt className="block-component" />
            'Content'
            <bdt className="else-block" />
        ...
        >
          ...
          >
            ...
            <bdt className="question">cdmikartiktimbadiya@gmail.com</bdt>. If we
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          ...
          >
            ...
            material br/each of our Legal Terms and your right to use our Services
        ...
        >
          <span style={{ fontSize: 15 }}>
            ...
            display, transmit, publish, distribute, or br/oadcast content and
        ...
        >
          <span style={{ fontSize: 15 }}>
            ...
            sell, resell, publish, br/oadcast, retitle, store, publicly perform,
        ...
        <ul>
          ...
          >
            ...
            <span style={{ fontSize: 15 }}>
              <bdt className="block-component" />'<bdt className="else-block" /> and
          ...
          >
            <span style={{ fontSize: 15 }}>
              ...
              <bdt className="statement-end-if-in-editor" /> are original to you or
              that you have the necessary rights and{" "}
              <bdt className="block-component" />
              licences
              <bdt className="else-block" /> to submit such Submissions
              <bdt className="block-component" /> and/or Contributions
              <bdt className="statement-end-if-in-editor" /> and that you have full
        ...
        >
          ...
          <bdt className="block-component" /> and/or Contributions
          <bdt className="statement-end-if-in-editor" /> and you expressly agree to
          reimburse us for any and all losses that we may suffer because of your
          br/each of (a) this section, (b) any third party’s intellectual property
        ...
        >
          ...
          opinion we consider such Contributions harmful or in br/each of these
        ...
        >
          ...
          <bdt className="statement-end-if-in-editor" />
          <bdt className="block-component" />'<bdt className="else-block" /> section
          below.
          <bdt className="statement-end-if-in-editor" />
        </div>
        <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: 15 }}>
              ...
              <bdt className="block-component" />
              colours
              <bdt className="else-block" />, features, specifications, and details
              of the products available on the Services. However, we do not
              guarantee that the <bdt className="block-component" />
              colours
              <bdt className="else-block" />, features, specifications, and details
              of the products will be accurate, complete, reliable, current, or free
              of other errors, and your electronic display may not accurately
              reflect the actual <bdt className="block-component" />
              colours
              <bdt className="else-block" /> and details of the products.{" "}
              <bdt className="statement-end-if-in-editor" />
              All products are subject to availability
              <bdt className="block-component" />, and we cannot guarantee that
              items will be in stock
              <bdt className="statement-end-if-in-editor" />. We reserve the right
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          ...
          >
            in <bdt className="question">INR</bdt>.
          </span>
        </div>
      </div>
      <div align="center" style={{ lineHeight: "1.5" }}>
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          ...
          >
            ...
            <bdt className="block-component" />
            authorise
            <bdt className="else-block" /> us to charge your chosen payment provider
        ...
        <div className="MsoNormal" style={{ textAlign: "justify", lineHeight: 1 }}>
          ...
          >
            ...
            >
              ...
              in connection with any commercial <bdt className="block-component" />
              endeavours
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            Internet br/owser usage, use, launch, develop, or
                  ...
                  <bdt data-type="body">
                    ...
                    >
                      ...
                      >
                        ...
                        perform, publish, distribute, or br/oadcast content and
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <bdt className="block-component" />
                      licence
                      <bdt className="else-block" /> to host, use, copy, reproduce,
              ...
              <bdt data-type="body">
                ...
                >
                  ...
                  >
                    This <bdt className="block-component" />
                    licence
                    <bdt className="else-block" /> will apply to any form, media, or
      ...
      <div align="center" style={{ textAlign: "left" }}>
        ...
        >
          ...
          >
            ...
            (8) you may not <bdt className="block-component" />
            organise
            <bdt className="else-block" /> a campaign encouraging others to post
          ...
          <strong>
            ...
            <span style={{ color: "rgb(0, 58, 250)" }}>
              <bdt
                ...
                data-type="question"
              >
                https://dvysun-ecomm-k7ek9wqfz-kartiks-projects-6330a69c.vercel.app//privacy.php
              </bdt>
            </span>
          </strong>
      ...
      >
        ...
        >
          ...
          contact information provided below (a <bdt className="block-component" />
          'Notification'
          <bdt className="else-block" />
      ...
      >
        ...
        >
          ...
          INCLUDING WITHOUT LIMITATION FOR br/EACH OF ANY REPRESENTATION, WARRANTY,
      ...
      >
        ...
        >
          ...
          Services.
          <bdt className="block-component" /> We also reserve the right to modify or
      ...
      >
        ...
        >
          ...
          . <bdt className="question">DVYSUN</bdt> and yourself irrevocably consent
          that the courts of{" "}
          <span
            style={{
              fontSize: "11pt",
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          <bdt className="question">DVYSUN</bdt> shall also maintain the right to
          br/ing proceedings as to the substance of the matter in the courts of the
      ...
      >
        ...
        >
          ...
          USE YOUR BEST <bdt className="block-component" />
          JUDGEMENT
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: "14.6667px" }}>3</span>) br/each of these Legal
          Terms; (<span style={{ fontSize: "14.6667px" }}>4</span>) any br/each of
          ...
          <bdt className="block-component" />
          defence
          <bdt className="else-block" /> and control of any matter for which you are
          required to indemnify us, and you agree to cooperate, at your expense,
          with our <bdt className="block-component" />
          defence
      ...
      >
        <strong>
          ...
          >
            <strong>
              <bdt className="block-component" />
              Phone: <bdt className="question">+91 98751 03176</bdt>
              <bdt className="statement-end-if-in-editor" />
            </strong>
          </span>
          &nbsp;
