...
const Contact = () => {
  return (
    <div><section class="bg-blue-50 dark:bg-slate-800" id="contact">
              ...
              <ul class="mb-6 md:mb-0">
                <li class="flex">
                  ...
                  <div class="ml-4 mb-4">
                    ...
                    <p class="text-gray-600 dark:text-slate-400">motavarachha surat</p>
                    <p class="text-gray-600 dark:text-slate-400">Gujrat , India</p>
                  </div>
                </li>
                <li class="flex">
                  <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                  ...
                  <div class="ml-4 mb-4">
                    ...
                    <p class="text-gray-600 dark:text-slate-400">Mobile: +91 98751 03176</p>
                    <p class="text-gray-600 dark:text-slate-400">Mail: cdmikartiktimbadiya@gmail.com</p>
                  </div>
                </li>
                <li class="flex">
                  <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
